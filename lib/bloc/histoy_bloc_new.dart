...
//
// import 'hitory_database.dart';
//
//
//
// class HistoryBlocData {
...
//   DatabaseHistory? databaseConfig;
//
//   initDatabase() async {
//     databaseConfig = new DatabaseHistory();
...
//   }
//
//   incrementAndUpdate(CartItem cartItem, int quantity) async {
//     ProductItem productItem = cartItem;
//     await databaseConfig?.createCustomer(productItem);
//     await getProducts();
...
//   }
//
//   decrementAndUpdate(CartItem cartItem, int quantity) async {
//     ProductItem productItem = cartItem;
